...
uses
  ...
  uNuevaEmpresa in 'uNuevaEmpresa.pas' {frmNuevaEmpresa},
  uPostgreSQLInstaller in 'uPostgreSQLInstaller.pas',
  DataModule in 'DataModule.pas' {DataModule1: TDataModule},
  DataModuleImg in 'DataModuleImg.pas' {DataModule2: TDataModule},
